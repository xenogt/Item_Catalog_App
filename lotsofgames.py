...
# Create dummy user
User1 = User(name="John Doe", email="Jdoe@gmail.com",
             picture='https://avatars1.githubusercontent.com/u/10250169?v=4&u=547691968b55d81b894e607d4d7c16b6f0ea5d11&s=400')
session.add(User1)
session.commit()
